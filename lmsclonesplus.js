        ...
        blocks: [
          {
            ...
            text: '当我作为克隆体启动时，[INPUTA] 设为 [INPUTB]',
...

          {
            ...
            text: '碰到设有 [INPUTA] 为 [INPUTB] 的克隆体？',
            filter: [Scratch.TargetType.SPRITE],
            arguments: {
              INPUTA: {
                type: Scratch.ArgumentType.STRING,
...

          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '将克隆体设有 [INPUTC] 为 [INPUTD] 的变量 [INPUTA] 设为 [INPUTB]',
            filter: [Scratch.TargetType.SPRITE],
            arguments: {
              INPUTA: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            ...
            text: '克隆体设有 [INPUTC] 为 [INPUTB] 的变量 [INPUTA]',
            filter: [Scratch.TargetType.SPRITE],
            disableMonitor: true,
            arguments: {
              INPUTA: {
...

          {
            opcode: 'cloneExists',
            blockType: Scratch.BlockType.BOOLEAN,
            text: '带有[INPUTA]值为[INPUTB]的克隆体存在吗？',
            filter: [Scratch.TargetType.SPRITE],
            arguments: {
              INPUTA: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: '带有[INPUTB]值为[INPUTC]的克隆体的[INPUTA]',
            filter: [Scratch.TargetType.SPRITE],
            disableMonitor: true,
            arguments: {
              INPUTA: {
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '停止所有带有[INPUTA]值为[INPUTB]的克隆体中的脚本',
            filter: [Scratch.TargetType.SPRITE],
            arguments: {
              INPUTA: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '删除所有带有[INPUTA]值为[INPUTB]的克隆体',
            filter: [Scratch.TargetType.SPRITE],
            arguments: {
              INPUTA: {
                type: Scratch.ArgumentType.STRING,
