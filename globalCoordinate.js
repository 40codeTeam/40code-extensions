        ...
        blocks: [
          {
            ...
            blockIconURI: icon,
            text: '移到 x: [x] y: [y] 角度 [r] 大小 [s] 跟随屏幕 [screen]',
            arguments: {
              x: {
          ...
          },
          {
            opcode: 'set',
            blockType: Scratch.BlockType.COMMAND,
            text: '设置屏幕 [screen] 的 x: [x] y: [y] 方向: [r] 大小: [s]',
            arguments: {
              x: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: '0'
