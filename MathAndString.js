            ...
            return {
                ...
                blocks: [
                    ...
                    '---',
                    {
                        opcode: 'triangle',
                        blockType: Scratch.BlockType.REPORTER,
                        text: '三角形 ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) 的 [CS]',
                        arguments: {
                            x1: {
                                type: Scratch.ArgumentType.NUMBER,
                                defaultValue: '0'
                    ...
                    },
                    {
                        opcode: 'rectangle',
                        blockType: Scratch.BlockType.REPORTER,
                        text: '四边形 ([x1],[y1]) ([x2],[y2]) ([x3],[y3]) ([x4],[y4]) 的 [CS]',
                        arguments: {
                            x1: {
                                type: Scratch.ArgumentType.NUMBER,
                                defaultValue: '0'
