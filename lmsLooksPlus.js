      ...
      return {
        ...
        blocks: [
...

          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: '将 [COSTUME] 的 [TYPE] 设置为 [CONTENT]',
            arguments: {
              TYPE: {
                type: Scratch.ArgumentType.STRING,
                menu: 'SVGPNG',
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: '[TARGET] 的第 [COSTUME] 个角色的 [CONTENT]',
            arguments: {
              CONTENT: {
                type: Scratch.ArgumentType.STRING,
                menu: 'contentType',
...

          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: '将 [SVG] 中的 [COLOR1] 替换为 [COLOR2]',
            arguments: {
              COLOR1: {
